    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        if "group" in view_kwargs:
            ...
            if "account" in view_kwargs:
                ...
                try:
                    view_kwargs["account"] = view_kwargs[
                        "group"
                    ].account_set.get(slug=view_kwargs["account"])
            ...
            if "settlement" in view_kwargs:
                ...
                try:
                    view_kwargs["settlement"] = view_kwargs[
                        "group"
                    ].settlement_set.get(id=view_kwargs["settlement"])
            ...
            if "transaction" in view_kwargs:
                ...
                try:
                    view_kwargs["transaction"] = view_kwargs[
                        "group"
                    ].transaction_set_with_rejected.get(
            ...
            if "list" in view_kwargs:
                ...
                try:
                    view_kwargs["list"] = view_kwargs["group"].list_set.get(
            ...
            if "bill" in view_kwargs:
                ...
                try:
                    view_kwargs["bill"] = Bill.objects.get(
                        id=view_kwargs["bill"], group=view_kwargs["group"]
                    )
