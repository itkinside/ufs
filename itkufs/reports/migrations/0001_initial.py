...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'List'
        db.create_table('reports_list', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
            ('account_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('short_name_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('balance_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='list_set', to=orm['accounting.Group'])),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('add_active_accounts', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('ignore_blocked', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        ...
        db.create_table('reports_list_extra_accounts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('list', models.ForeignKey(orm['reports.list'], null=False)),
            ('account', models.ForeignKey(orm['accounting.account'], null=False))
        ))
        db.create_unique('reports_list_extra_accounts', ['list_id', 'account_id'])

        # Adding model 'ListColumn'
        db.create_table('reports_listcolumn', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('width', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(related_name='column_set', to=orm['reports.List'])),
        ))
    ...
    models = {
        ...
        'reports.list': {
            'Meta': {'ordering': "('name',)", 'unique_together': "(('slug', 'group'),)", 'object_name': 'List'},
            'account_width': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'add_active_accounts': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'balance_width': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'double': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'extra_accounts': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['accounting.Account']", 'symmetrical': 'False', 'blank': "'true'"}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'list_set'", 'to': "orm['accounting.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ignore_blocked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'orientation': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'short_name_width': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'})
        },
        'reports.listcolumn': {
            'Meta': {'ordering': "['id']", 'object_name': 'ListColumn'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'column_set'", 'to': "orm['reports.List']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
